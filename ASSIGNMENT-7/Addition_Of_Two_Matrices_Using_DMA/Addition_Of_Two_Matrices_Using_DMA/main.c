...
Que : 4. Write a C program to add two matrices in third Matrix(Using Dynamic Memory Allocation).
...
void main() {
	...
	// Array 3 for storing the result of addition of array 1 and 2 ...
