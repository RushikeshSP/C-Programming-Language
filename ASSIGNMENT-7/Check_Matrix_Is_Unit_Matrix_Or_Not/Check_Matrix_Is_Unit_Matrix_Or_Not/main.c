...
Que : 8. Write C Program to Check if a given Matrix is an Unit Matrix. (Using Dynamic Memory Allocation).
...
void main() {
	...
	// Logic to check given matrix is unit matrix or not..
	int flag = 0;
	for (int i = 0; i < row; i++)
	{
		for (int j = 0; j < col; j++)
	...
	if (flag == 1) {
		printf("The given matrix is not an unit matrix.");
	}
	else {
		printf("The given matrix is an unit matrix.");
	}
